			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
						<li class="ftco-animate"><a href="https://wa.me/6281316801062?text=Halo%20saya%20ingin%20bertanya%20tentang%20produk%20Anda" target="_blank"><span
									class="bi bi-whatsapp"></span></a>
						</li>
						<li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
						<li class="ftco-animate"><a href="https://www.instagram.com/setiadyyfr/"><span
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<div class="block-23 mb-3">
						<ul>
							<li><a href="https://maps.app.goo.gl/aRWK8r2DAqy5LsdY7"><span
										class="icon icon-map-marker"></span><span
										class="text"><?php echo get_settings('store_address'); ?></span></a></li>
							<li><a href="tel:6281316801062"><span class="icon icon-phone"></span><span
										class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
							<li><a href="mailto:Setiadyyfriandika24@gmail.com"><span class=" icon icon-envelope"></span><span
